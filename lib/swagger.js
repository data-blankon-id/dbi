...
server.register({
  ...
  options: {
    swaggerOptions: {
      validatorUrl : '/swagger/validator' // options, options, options
    },
    title: 'Data.BlankOn.id',
    authorization: {
      field: 'apiKey',
...
server.route({
  ...
  method: 'GET',
  handler: function (request, reply) {
    var r = quest('http://online.swagger.io/validator/?url=https://data.blankon.id/swagger/swagger'); // options, options, options
